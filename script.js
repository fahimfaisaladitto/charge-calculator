...
const translations = {
    bn: {
        'title': 'ক্যাশআউট খরচ হিসাব',
        'subtitle': 'মোবাইল ব্যাংকিং ফি হিসাব করুন',
        ...
        'fee_comparison_label': 'খরচ তুলনা দেখুন',
        'comparison_table_header': 'সবচেয়ে কম খরচের ১০টি মাধ্যম',
        'table_provider': 'প্রদানকারী',
        'table_method': 'পদ্ধতি',
        'table_charge': 'চার্জ (টাকা)',
        'currency': 'টাকা',
        'error_invalid_amount': 'অনুগ্রহ করে একটি সঠিক পরিমাণ লিখুন।',
